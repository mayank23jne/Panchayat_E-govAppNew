...
export default function SignInScreen() {
  ...
  try {
    ...
    alert(error.message || "Authentication failed due to a network connection error.");
  } finally {
    setIsLoading(false);
  }
};

  const inputStyle = "w-full border border-slate-200 bg-white rounded-xl px-5 py-4 text-base text-slate-900 shadow-inner";
      ...
      <SafeAreaView className="flex-1">
        ...
        >
          <View className="flex-1 justify-between px-8 pt-8 pb-12">
            ...
            <View className="gap-y-6 flex-grow">
              <View>
              ...
              <View>
                <View className="flex-row justify-between items-baseline mb-2 ml-0.5">
                  ...
                  {/* <TouchableOpacity activeOpacity={0.7}>
                    <Text className="text-xs font-semibold text-blue-600">Forgot?</Text>
                  </TouchableOpacity> */}
                </View>
                <TextInput
                  className={inputStyle}
          ...
          <TouchableOpacity
            ...
            disabled={isLoading}
            className="w-full h-14 bg-blue-600 rounded-xl items-center justify-center shadow-lg shadow-blue-600/20 active:opacity-85"
            activeOpacity={0.8}
          >
            {isLoading ? (
